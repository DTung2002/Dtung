...
import 'package:education_app/screens/videoplay.dart';
...
class LessonCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        if (lesson.name == 'Giới thiệu Flutter') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PlayVideoScreen(index: 0,),
            ),
          );
        } else if(lesson.name == "Cài dặt môi trường") {
          Navigator.push(context,
            MaterialPageRoute(builder: (context) => PlayVideoScreen(index: 1,),
            ),
          );
        }else if(lesson.name == "Tạo dự án đầu tiên") {
          Navigator.push(context,
